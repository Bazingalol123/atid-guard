...
namespace AuthWithAdmin.Server.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var props = new AuthenticationProperties { RedirectUri = "api/users/signin-google" };
        ...
        public async Task<IActionResult> GoogleLogin()
        {
            ...
            switch (token)
            {
                ...
                default:
                    ...
                    string redirectUrl = $"{getPath()}/Redirect?token={token}";
        ...
        public async Task<IActionResult> ResetPasswordAPI(string token)
        {
            ...
            if (results != AuthResults.Success)
                return Redirect($"{getPath()}/login");

            return Redirect($"{getPath()}/ResetPassword?token={Uri.EscapeDataString(token)}");
        }
        ...
        public async Task<IActionResult> VerifyEmail(string token)
        {
            ...
            switch (results)
            {
                case AuthResults.InvalidToken:
                    return Redirect($"{getPath()}/VerifyEmail");
                ...
                default:
                    string redirectUrl = $"{getPath()}/Redirect?token={results}";
                    return Redirect(redirectUrl);
            }
        }
